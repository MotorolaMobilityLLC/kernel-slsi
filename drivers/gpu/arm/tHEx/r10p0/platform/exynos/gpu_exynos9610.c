...
static gpu_dvfs_info gpu_dvfs_table_default[] = {
	{949, 950000, 0, 98, 100, 1, 0, 2093000, 667000, 1534000, CPU_MAX}, /* L0*/
	{839, 950000, 0, 97,  99, 1, 0, 2093000, 667000, 1534000, CPU_MAX}, /* L1*/
	{764, 900000, 0, 90,  99, 1, 0, 1539000, 533000, 1456000, CPU_MAX}, /* L2*/
	{683, 850000, 0, 90,  95, 1, 0, 1539000, 400000, 1456000, CPU_MAX}, /* L3*/
	{572, 800000, 0, 90,  95, 1, 0, 1539000, 200000, 1456000, CPU_MAX}, /* L4*/
	{546, 750000, 0, 90,  95, 1, 0, 1352000, 200000, 1326000, CPU_MAX}, /* L5*/
	{455, 750000, 0, 90,  95, 1, 0,  676000, 200000,  702000, CPU_MAX}, /* L6*/
	{385, 700000, 0, 85,  95, 1, 0,  546000, 100000,  598000, CPU_MAX}, /* L7*/
	{338, 700000, 0, 70,  90, 1, 0,  419000, 100000,  403000, CPU_MAX}, /* L8*/
	{260, 700000, 0, 70,  90, 1, 0,  419000, 100000,  403000, CPU_MAX}, /* L9*/
};
