...
#if 0
static int et320_spi_probe(struct spi_device *spi)
{
//	struct device *dev = &spi->dev;
	int error = 0;
	et320_data_t *et320 = NULL;
	/* size_t buffer_size; */

	printk(KERN_ERR "et320_spi_probe enter++++++\n");
//#if 1
	et320 = kzalloc(sizeof(*et320), GFP_KERNEL);
	if (!et320) {
		/*
		dev_err(&spi->dev,
...
#if 0
static int et320_spi_remove(struct spi_device *spi)
{
...
#if 0
static struct of_device_id et320_spi_of_match[] = {
...
//MODULE_DEVICE_TABLE(of, et320_spi_of_match);
...
static struct spi_driver spi_driver = {
	.driver = {
		.name	= "et320",
		.owner	= THIS_MODULE,
		.of_match_table = et320_spi_of_match,
        .bus	= &spi_bus_type,
	},
	.probe	= et320_spi_probe,
	.remove	= et320_spi_remove
};
#endif
