...
static struct bts_info exynos_bts[] = {
	[BTS_IDX_ABOX] = {
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.priority = 0xC,
	},
	[BTS_IDX_COREX] = {
		.name = "corex",
	...
	[BTS_IDX_CAM] = {
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.priority = 0xC,
		.table[BS_CAMERA_THERMAL].stat.rmo = 0x18,
		.table[BS_CAMERA_THERMAL].stat.wmo = 0x18,
		.table[BS_CAMERA_THERMAL].stat.timeout_en = true,
		.table[BS_CAMERA_THERMAL].stat.timeout_r = 0xc,
		.table[BS_CAMERA_THERMAL].stat.timeout_w = 0xc,
	},
	[BTS_IDX_DPU] = {
		.name = "dpu",
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.priority = 0xA,
		.table[BS_CAMERA_THERMAL].stat.rmo = 0x20,
		.table[BS_CAMERA_THERMAL].stat.wmo = 0x20,
		.table[BS_CAMERA_THERMAL].stat.timeout_en = true,
		.table[BS_CAMERA_THERMAL].stat.timeout_r = 0x20,
		.table[BS_CAMERA_THERMAL].stat.timeout_w = 0x20,
	},
	[BTS_IDX_DIT] = {
		.name = "dit",
	...
	[BTS_IDX_G2D] = {
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.priority = 0x4,
		.table[BS_CAMERA_THERMAL].stat.rmo = 0x8,
		.table[BS_CAMERA_THERMAL].stat.wmo = 0x8,
		.table[BS_CAMERA_THERMAL].stat.max_rmo = 0x1,
		.table[BS_CAMERA_THERMAL].stat.max_wmo = 0x1,
	},
	[BTS_IDX_G3D] = {
		.name = "g3d",
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.priority = 0x4,
		.table[BS_CAMERA_THERMAL].stat.rmo = 0x4,
		.table[BS_CAMERA_THERMAL].stat.wmo = 0x4,
		.table[BS_CAMERA_THERMAL].stat.max_rmo = 0x1,
		.table[BS_CAMERA_THERMAL].stat.max_wmo = 0x1,
	},
	[BTS_IDX_GNSS] = {
	...
	[BTS_IDX_VIPX1] = {
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.priority = 0x4,
		.table[BS_CAMERA_THERMAL].stat.rmo = 0x10,
		.table[BS_CAMERA_THERMAL].stat.wmo = 0x10,
		.table[BS_CAMERA_THERMAL].stat.max_rmo = 0x4,
		.table[BS_CAMERA_THERMAL].stat.max_wmo = 0x4,
	},
	[BTS_IDX_VIPX2] = {
		.name = "vipx2",
...
static struct drex_info exynos_drex[] = {
	[DREX_IDX_0] = {
		...
		.table[BS_CAMERA_THERMAL].stat.scen_en = true,
		.table[BS_CAMERA_THERMAL].stat.write_flush_config[0] = 0xB4301606,
		.table[BS_CAMERA_THERMAL].stat.write_flush_config[1] = 0x1810100A,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x0] = 0x000A0180,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x1] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x2] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x3] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x4] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x5] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x6] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x7] = 0x000A0100,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x8] = 0x000A0080,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0x9] = 0x000A0060,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0xA] = 0x000A0040,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0xB] = 0x000A0020,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0xC] = 0x000A0010,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0xD] = 0x000A0008,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0xE] = 0x000A0004,
		.table[BS_CAMERA_THERMAL].stat.drex_timeout[0xF] = 0x000A0001,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[0] = 0x00C100C1,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[1] = 0x00C100C1,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[2] = 0x00C100C1,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[3] = 0x00C100C1,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[4] = 0x00C100C1,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[5] = 0x000D001A,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[6] = 0x00030007,
		.table[BS_CAMERA_THERMAL].stat.vc_timer_th[7] = 0x00010001,
		.table[BS_CAMERA_THERMAL].stat.cutoff_con = 0x00000005,
		.table[BS_CAMERA_THERMAL].stat.brb_cutoff_config = 0x00020002,
	},
	[DREX_IDX_1] = {
		.name = "drex1",
