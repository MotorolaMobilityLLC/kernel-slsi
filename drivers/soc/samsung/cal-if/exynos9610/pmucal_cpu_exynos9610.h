...
struct pmucal_seq core00_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU0_CONFIGURATION", 0x11860000, 0x2000, (0xf << 0), (0xF << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core00_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU0_CONFIGURATION", 0x11860000, 0x2000, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core00_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_CPU0_STATUS", 0x11860000, 0x2004, (0xf << 0), 0, 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core01_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU1_CONFIGURATION", 0x11860000, 0x2080, (0xf << 0), (0xF << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core01_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU1_CONFIGURATION", 0x11860000, 0x2080, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core01_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_CPU1_STATUS", 0x11860000, 0x2084, (0xf << 0), 0, 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core02_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU2_CONFIGURATION", 0x11860000, 0x2100, (0xf << 0), (0xF << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core02_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU2_CONFIGURATION", 0x11860000, 0x2100, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core02_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_CPU2_STATUS", 0x11860000, 0x2104, (0xf << 0), 0, 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core03_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU3_CONFIGURATION", 0x11860000, 0x2180, (0xf << 0), (0xF << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core03_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPU3_CONFIGURATION", 0x11860000, 0x2180, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core10_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU0_CONFIGURATION", 0x11860000, 0x2200, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core11_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU1_CONFIGURATION", 0x11860000, 0x2280, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core12_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU2_CONFIGURATION", 0x11860000, 0x2300, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
...
struct pmucal_seq core13_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPU3_CONFIGURATION", 0x11860000, 0x2380, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq core13_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPU3_STATUS", 0x11860000, 0x2384, (0xf << 0), 0, 0, 0, 0xffffffff, 0),
};
struct pmucal_seq cluster0_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPUSEQUENCER_OPTION", 0x11860000, 0x2488, (0x1 << 4), (0x1 << 4), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPUSEQUENCER_OPTION", 0x11860000, 0x2488, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq cluster0_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "EMBEDDED_CMU_CPUCL0_SYS_PWR_REG", 0x11860000, 0x1420, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPUSEQUENCER_OPTION", 0x11860000, 0x2488, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER0_CPUSEQUENCER_OPTION", 0x11860000, 0x2488, (0x1 << 4), (0x0 << 4), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq cluster0_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER0_CPUSEQUENCER_STATUS", 0x11860000, 0x2484, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
struct pmucal_seq cluster1_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_SHORTSTOP", 0x10900000, 0x0820, (0xffffffff << 0), (0xFFFFFFFF << 0), 0, 0, 0xffffffff, 0),
	...
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPUSEQUENCER_STATUS", 0x11860000, 0x24A4, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq cluster1_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "EMBEDDED_CMU_CPUCL1_SYS_PWR_REG", 0x11860000, 0x1424, (0xf << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPUSEQUENCER_OPTION", 0x11860000, 0x24A8, (0x1 << 0), (0x1 << 0), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER1_CPUSEQUENCER_OPTION", 0x11860000, 0x24A8, (0x1 << 4), (0x0 << 4), 0, 0, 0xffffffff, 0),
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPUSEQUENCER_STATUS", 0x11860000, 0x24A4, (0x1 << 0), (0x0 << 0), 0, 0, 0xffffffff, 0),
};
struct pmucal_seq cluster1_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_CPUSEQUENCER_STATUS", 0x11860000, 0x24A4, (0x1 << 0), 0, 0, 0, 0xffffffff, 0),
};
